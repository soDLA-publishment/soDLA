...
analyze -format sverilog -library spec ../../small_gold/vmod/nvdla/nocif/NV_NVDLA_DMAIF_wr.v
analyze -format sverilog -library impl {../../small_gate/vmod/nvdla/nocif/NV_NVDLA_DMAIF_wr_wrapper.v 
                                        ../../small_gate/vmod/nvdla/nocif/NV_NVDLA_DMAIF_wr.v}

elaborate_seq -spectop NV_NVDLA_DMAIF_wr -impltop NV_NVDLA_DMAIF_wr_wrapper
