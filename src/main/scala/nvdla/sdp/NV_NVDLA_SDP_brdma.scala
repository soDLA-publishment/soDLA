...
//         io.dma_rd_rsp_vld := u_NV_NVDLA_SDP_RDMA_dmaif.io.dma_rd_rsp_vld
//         u_NV_NVDLA_SDP_RDMA_dmaif.io.dma_rd_rsp_rdy := io.dma_rd_rsp_rdy
//         io.dma_rd_rsp_pd := u_NV_NVDLA_SDP_RDMA_dmaif.io.dma_rd_rsp_pd
//         u_NV_NVDLA_SDP_RDMA_dmaif.io.dma_rd_cdt_lat_fifo_pop := io.dma_rd_cdt_lat_fifo_pop
