...
//=================================================
    ...
    val less_than_win_s = MuxLookup(
        Cat(dec_offset_datin_msb(pPP_BW), reg2dp_X_offset(pPP_BW)), 
        (dec_offset_datin_msb <= reg2dp_X_offset(pPP_BW,0)),
        Array(  "b01".asUInt(2.W) -> false.B,
                "b10".asUInt(2.W) -> true.B)
        )
    
    val dec_offset_msb = RegInit(0.U((pPP_BW+2).W))
...
//log2 logic , bypassed when X is a linear table
    ...
    val log2_datin_msb = dec_offset_msb(pPP_BW,0)
...
//Note need modify "my $k = 21" if BW changed.
                when(log2_datin_msb(21)){
                    log2_datout_msb := 21.U(22.W)
                    log2_frac_msb := log2_datin_msb(20,0)
                }.elsewhen(log2_datin_msb(20)){
                    log2_datout_msb := 20.U(22.W)
                    log2_frac_msb := Cat(log2_datin_msb(19,0), "b0".asUInt(1.W))
                }.elsewhen(log2_datin_msb(19)){
                    log2_datout_msb := 19.U(22.W)
                    log2_frac_msb := Cat(log2_datin_msb(18,0), "b0".asUInt(2.W))
                }.elsewhen(log2_datin_msb(18)){
                    log2_datout_msb := 18.U(22.W)
                    log2_frac_msb := Cat(log2_datin_msb(17,0), "b0".asUInt(3.W))
                }.elsewhen(log2_datin_msb(17)){
                    log2_datout_msb := 17.U(22.W)
                    log2_frac_msb := Cat(log2_datin_msb(16,0), "b0".asUInt(4.W))
                }.elsewhen(log2_datin_msb(16)){
                    log2_datout_msb := 16.U(22.W)
                    log2_frac_msb := Cat(log2_datin_msb(15,0), "b0".asUInt(5.W))
                }.elsewhen(log2_datin_msb(15)){
                    log2_datout_msb := 15.U(22.W)
                    log2_frac_msb := Cat(log2_datin_msb(14,0), "b0".asUInt(6.W))
                }.elsewhen(log2_datin_msb(14)){
                    log2_datout_msb := 14.U(22.W)
                    log2_frac_msb := Cat(log2_datin_msb(13,0), "b0".asUInt(7.W))
                }.elsewhen(log2_datin_msb(13)){
                    log2_datout_msb := 13.U(22.W)
                    log2_frac_msb := Cat(log2_datin_msb(12,0), "b0".asUInt(8.W))
                }.elsewhen(log2_datin_msb(12)){
                    log2_datout_msb := 12.U(22.W)
                    log2_frac_msb := Cat(log2_datin_msb(11,0), "b0".asUInt(9.W))
                }.elsewhen(log2_datin_msb(11)){
                    log2_datout_msb := 11.U(22.W)
                    log2_frac_msb := Cat(log2_datin_msb(10,0), "b0".asUInt(10.W))
                }.elsewhen(log2_datin_msb(10)){
                    log2_datout_msb := 10.U(22.W)
                    log2_frac_msb := Cat(log2_datin_msb(9,0), "b0".asUInt(11.W))
                }.elsewhen(log2_datin_msb(9)){
                    log2_datout_msb := 9.U(22.W)
                    log2_frac_msb := Cat(log2_datin_msb(8,0), "b0".asUInt(12.W))
                }.elsewhen(log2_datin_msb(8)){
                    log2_datout_msb := 8.U(22.W)
                    log2_frac_msb := Cat(log2_datin_msb(7,0), "b0".asUInt(13.W))
                }.elsewhen(log2_datin_msb(7)){
                    log2_datout_msb := 7.U(22.W)
                    log2_frac_msb := Cat(log2_datin_msb(6,0), "b0".asUInt(14.W))
                }.elsewhen(log2_datin_msb(6)){
                    log2_datout_msb := 6.U(22.W)
                    log2_frac_msb := Cat(log2_datin_msb(5,0), "b0".asUInt(15.W))
                }.elsewhen(log2_datin_msb(5)){
                    log2_datout_msb := 5.U(22.W)
                    log2_frac_msb := Cat(log2_datin_msb(4,0), "b0".asUInt(16.W))
                }.elsewhen(log2_datin_msb(4)){
                    log2_datout_msb := 4.U(22.W)
                    log2_frac_msb := Cat(log2_datin_msb(3,0), "b0".asUInt(17.W))
                }.elsewhen(log2_datin_msb(3)){
                    log2_datout_msb := 3.U(22.W)
                    log2_frac_msb := Cat(log2_datin_msb(2,0), "b0".asUInt(18.W))
                }.elsewhen(log2_datin_msb(2)){
                    log2_datout_msb := 2.U(22.W)
                    log2_frac_msb := Cat(log2_datin_msb(1,0), "b0".asUInt(19.W))
                }.elsewhen(log2_datin_msb(1)){
                    log2_datout_msb := 1.U(22.W)
                    log2_frac_msb := Cat(log2_datin_msb(0), "b0".asUInt(20.W))
                }.elsewhen(log2_datin_msb(0)){
                    log2_datout_msb := Fill(pPP_BW+1, false.B)
                    log2_frac_msb := Fill(pPP_BW, false.B)
                }
            }.otherwise{
...
//exp index offset , only valid for exponent table
    ...
    val dec_Xindex_msb = RegInit(0.U((pPP_BW+3).W))
    ...
    when(load_int_stage1){
        when(dat_info(16)){
            ...
            dec_Xindex_msb := Cat(0.U(2.W), dec_Xindex_datin_msb)
            int_X_index_uflow_msb := false.B
        }
    }
