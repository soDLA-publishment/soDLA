...
analyze -format sverilog -library impl {../../small_gate/vmod/nvdla/nocif/NV_NVDLA_MCIF_WRITE_IG_bpt_wrapper.v 
                                        ../../small_gate/vmod/nvdla/nocif/NV_NVDLA_MCIF_WRITE_IG_bpt.v}

elaborate_seq -spectop NV_NVDLA_MCIF_WRITE_IG_bpt -impltop NV_NVDLA_MCIF_WRITE_IG_bpt_wrapper
