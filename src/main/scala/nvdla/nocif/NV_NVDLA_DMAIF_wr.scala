...
//         val cvif_wr_req_valid = Output(Bool())
//         val cvif_wr_req_ready = Input(Bool())
//         val cvif_wr_req_pd = Output(UInt(DMABW.W))
...
//         cvio.get.cvif_wr_req_valid := is_pipe2.io.vo
//         is_pipe2.io.ri := cvio.get.cvif_wr_req_ready
//         cvio.get.cvif_wr_req_pd := is_pipe2.io.dout
...
//     if(conf.NVDLA_SECONDARY_MEMIF_ENABLE){
//         cv_dma_wr_rsp_complete.get := cvio.get.cvif_wr_rsp_complete
//     }
