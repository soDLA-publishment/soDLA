...
analyze -format sverilog -library impl {../../small_gate/vmod/nvdla/fifo/NV_NVDLA_MCIF_READ_eg_fifo_wrapper.v 
                                        ../../small_gate/vmod/nvdla/fifo/NV_NVDLA_MCIF_READ_eg_fifo.v}

elaborate_seq -spectop NV_NVDLA_MCIF_READ_EG_lat_fifo -impltop NV_NVDLA_MCIF_READ_eg_fifo_wrapper
