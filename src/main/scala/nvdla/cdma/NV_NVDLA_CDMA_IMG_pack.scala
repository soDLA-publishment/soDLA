...
//         //img2sbuf
//         val img2sbuf_p_rd = Vec(conf.ATMM_NUM, new nvdla_wr_if(8, conf.ATMM))
...
// }
// else if(ATMM_NUM == 4){
//     rd_loop_cnt_limit := img_p0_burst(3, 2) + img_p0_burst(1, 0).orR
// }
...
// if(ATMM_NUM == 1 || ATMM_NUM == 2){
//     rd_pburst_limit := Mux((rd_planar_cnt & (~is_last_loop | ~img_p1_burst(0))), "b1".asUInt(2.W), "b0".asUInt(2.W))
// }
// else if(ATMM_NUM == 4){
//     rd_pburst_limit := Mux(rd_planar_cnt & (~is_last_loop | (img_p1_burst(1, 0) === 0.U)), "b3".asUInt(2.W), 
//                        Mux(rd_planar_cnt & (~is_last_loop | (img_p1_burst(1, 0) === 1.U)), "b0".asUInt(2.W),
//                        Mux(rd_planar_cnt & (~is_last_loop | (img_p1_burst(1, 0) === 2.U)), "b1".asUInt(2.W),
//                        "b2".asUInt(2.W))))
// }
