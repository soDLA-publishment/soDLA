...
analyze -format sverilog -library impl {../../small_gate/vmod/nvdla/nocif/NV_NVDLA_MCIF_WRITE_eg_wrapper.v 
                                        ../../small_gate/vmod/nvdla/nocif/NV_NVDLA_MCIF_WRITE_eg.v}

elaborate_seq -spectop NV_NVDLA_MCIF_WRITE_eg -impltop NV_NVDLA_MCIF_WRITE_eg_wrapper
