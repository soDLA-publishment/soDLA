...
// ///// Address decode
    ...
    val nvdla_pdp_rdma_s_pointer_0_out = Cat("b0".asUInt(15.W), io.consumer, "b0".asUInt(15.W), io.producer)
    val nvdla_pdp_rdma_s_status_0_out = Cat("b0".asUInt(14.W), io.status_1, "b0".asUInt(14.W), io.status_0)

// ///// Output mux  
    io.reg_rd_data := MuxLookup(io.reg_offset, "b0".asUInt(32.W), 
    Seq(      
    "h4".asUInt(32.W)  -> nvdla_pdp_rdma_s_pointer_0_out,
    "h0".asUInt(32.W)  -> nvdla_pdp_rdma_s_status_0_out
    ))
