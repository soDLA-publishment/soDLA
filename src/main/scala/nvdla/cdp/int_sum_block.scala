...
withClock(io.nvdla_core_clk){
    ...
    for(i <- 0 to 8){
        sq(i) := Cat(Fill(16, false.B), io.sq_pd_int8_lsb(i))
    }
    ...
    when(io.load_din_d){
        sq4_d := Cat(Fill(16, false.B), io.sq_pd_int8_lsb(4))
    }
    ...
    when(io.load_din_2d){
        int8_msb_sum3 := int8_msb_sum_3_5 +& Cat(false.B, sq_pd_int8_msb_4_d)
    }
    when(io.load_din_2d &(io.len5|io.len7|io.len9)){
        int8_msb_sum5 := (int8_msb_sum_3_5 +& Cat(false.B, sq_pd_int8_msb_4_d)) +& Cat(false.B, int8_msb_sum_2_6)
    }
    when(io.load_din_2d &(io.len7|io.len9)){
        int8_msb_sum7 := (int8_msb_sum_3_5 +& Cat(false.B, sq_pd_int8_msb_4_d)) +& (int8_msb_sum_2_6 +& int8_msb_sum_1_7)
    }
    when(io.load_din_2d &(io.len9)){
        int8_msb_sum9 := ((int8_msb_sum_3_5 +& Cat(false.B, sq_pd_int8_msb_4_d)) +& (int8_msb_sum_2_6 +& int8_msb_sum_1_7)) + Cat(Fill(2, false.B), int8_msb_sum_0_8)
    }
    ...
    when(io.load_din_2d){
        int16_sum3 := int16_sum_3_5 +& Cat(false.B, sq4_d)
    }
    when(io.load_din_2d&(io.len5|io.len7|io.len9)){
        int16_sum5 := (int16_sum_3_5 +& Cat(false.B, sq4_d)) +& Cat(false.B, int16_sum_2_6)
    } 
    when(io.load_din_2d &(io.len7|io.len9)){
        int16_sum7 := (int16_sum_3_5 +& Cat(false.B, sq4_d)) +& (int16_sum_2_6 +& int16_sum_1_7)
    }
    when(io.load_din_2d &(io.len9)){
        int16_sum9 := ((int16_sum_3_5 +& Cat(false.B, sq4_d)) +& (int16_sum_2_6 +& int16_sum_1_7)) +& Cat(Fill(2, false.B), int16_sum_0_8)
    }     
