...
//     //cvif
//     val sdp_b2cvif_rd_req_valid = Output(Bool())
//     val sdp_b2cvif_rd_req_ready = Input(Bool())
//     val sdp_b2cvif_rd_req_pd = Output(UInt(conf.NVDLA_DMA_RD_REQ.W))
//     val cvif2sdp_b_rd_rsp_valid  = Input(Bool())
//     val cvif2sdp_b_rd_rsp_ready = Output(Bool())
//     val cvif2sdp_b_rd_rsp_pd = Input(UInt(conf.NVDLA_DMA_RD_RSP.W))
