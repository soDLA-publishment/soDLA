...
class NV_NVDLA_SDP_RDMA_REG_dual extends Module{
    ...
    // Address decode
    val nvdla_sdp_rdma_d_bn_base_addr_high_0_wren = (io.reg_offset === "h48".asUInt(32.W)) & io.reg_wr_en
    val nvdla_sdp_rdma_d_bn_base_addr_low_0_wren = (io.reg_offset ===  "h44".asUInt(32.W)) & io.reg_wr_en
    val nvdla_sdp_rdma_d_bn_batch_stride_0_wren = (io.reg_offset ===  "h54".asUInt(32.W)) & io.reg_wr_en
    val nvdla_sdp_rdma_d_bn_line_stride_0_wren = (io.reg_offset ===  "h4c".asUInt(32.W)) & io.reg_wr_en
    val nvdla_sdp_rdma_d_bn_surface_stride_0_wren = (io.reg_offset === "h50".asUInt(32.W)) & io.reg_wr_en
    val nvdla_sdp_rdma_d_brdma_cfg_0_wren = (io.reg_offset === "h28".asUInt(32.W)) & io.reg_wr_en
    val nvdla_sdp_rdma_d_bs_base_addr_high_0_wren = (io.reg_offset === "h30".asUInt(32.W)) & io.reg_wr_en
    val nvdla_sdp_rdma_d_bs_base_addr_low_0_wren = (io.reg_offset === "h2c".asUInt(32.W)) & io.reg_wr_en
    val nvdla_sdp_rdma_d_bs_batch_stride_0_wren = (io.reg_offset === "h3c".asUInt(32.W)) & io.reg_wr_en
    val nvdla_sdp_rdma_d_bs_line_stride_0_wren = (io.reg_offset === "h34".asUInt(32.W)) & io.reg_wr_en
    val nvdla_sdp_rdma_d_bs_surface_stride_0_wren = (io.reg_offset === "h38".asUInt(32.W)) & io.reg_wr_en
    val nvdla_sdp_rdma_d_data_cube_channel_0_wren = (io.reg_offset === "h14".asUInt(32.W)) & io.reg_wr_en
    val nvdla_sdp_rdma_d_data_cube_height_0_wren = (io.reg_offset === "h10".asUInt(32.W)) & io.reg_wr_en
    val nvdla_sdp_rdma_d_data_cube_width_a_0_wren = (io.reg_offset === "h0c".asUInt(32.W)) & io.reg_wr_en
    val nvdla_sdp_rdma_d_erdma_cfg_0_wren = (io.reg_offset === "h58".asUInt(32.W)) & io.reg_wr_en
    val nvdla_sdp_rdma_d_ew_base_addr_high_0_wren = (io.reg_offset === "h60".asUInt(32.W)) & io.reg_wr_en
    val nvdla_sdp_rdma_d_ew_base_addr_low_0_wren = (io.reg_offset === "h5c".asUInt(32.W)) & io.reg_wr_en
    val nvdla_sdp_rdma_d_ew_batch_stride_0_wren = (io.reg_offset === "h6c".asUInt(32.W)) & io.reg_wr_en
    val nvdla_sdp_rdma_d_ew_line_stride_0_wren = (io.reg_offset === "h64".asUInt(32.W)) & io.reg_wr_en
    val nvdla_sdp_rdma_d_ew_surface_stride_0_wren = (io.reg_offset === "h68".asUInt(32.W)) & io.reg_wr_en
    val nvdla_sdp_rdma_d_feature_mode_cfg_0_wren = (io.reg_offset === "h70".asUInt(32.W)) & io.reg_wr_en
    val nvdla_sdp_rdma_d_nrdma_cfg_0_wren = (io.reg_offset === "h40".asUInt(32.W)) & io.reg_wr_en
    val nvdla_sdp_rdma_d_op_enable_0_wren = (io.reg_offset === "h08".asUInt(32.W)) & io.reg_wr_en
    val nvdla_sdp_rdma_d_perf_brdma_read_stall_0_wren = (io.reg_offset === "h88".asUInt(32.W)) & io.reg_wr_en
    val nvdla_sdp_rdma_d_perf_enable_0_wren = (io.reg_offset === "h80".asUInt(32.W)) & io.reg_wr_en
    val nvdla_sdp_rdma_d_perf_erdma_read_stall_0_wren = (io.reg_offset === "h90".asUInt(32.W)) & io.reg_wr_en
    val nvdla_sdp_rdma_d_perf_mrdma_read_stall_0_wren = (io.reg_offset === "h84".asUInt(32.W)) & io.reg_wr_en
    val nvdla_sdp_rdma_d_perf_nrdma_read_stall_0_wren = (io.reg_offset === "h8c".asUInt(32.W)) & io.reg_wr_en
    val nvdla_sdp_rdma_d_src_base_addr_high_0_wren = (io.reg_offset === "h1c".asUInt(32.W)) & io.reg_wr_en
    val nvdla_sdp_rdma_d_src_base_addr_low_0_wren = (io.reg_offset === "h18".asUInt(32.W)) & io.reg_wr_en
    val nvdla_sdp_rdma_d_src_dma_cfg_0_wren = (io.reg_offset === "h74".asUInt(32.W)) & io.reg_wr_en
    val nvdla_sdp_rdma_d_src_line_stride_0_wren = (io.reg_offset === "h20".asUInt(32.W)) & io.reg_wr_en
    val nvdla_sdp_rdma_d_src_surface_stride_0_wren = (io.reg_offset === "h24".asUInt(32.W)) & io.reg_wr_en
    val nvdla_sdp_rdma_d_status_inf_input_num_0_wren = (io.reg_offset === "h7c".asUInt(32.W)) & io.reg_wr_en
    val nvdla_sdp_rdma_d_status_nan_input_num_0_wren = (io.reg_offset === "h78".asUInt(32.W)) & io.reg_wr_en
    ...
    "h48".asUInt(32.W)  -> io.bn_base_addr_high,
    //nvdla_sdp_rdma_d_bn_base_addr_low_0_out
    "h44".asUInt(32.W)  -> io.bn_base_addr_low,
    //nvdla_sdp_rdma_d_bn_batch_stride_0_out
    "h54".asUInt(32.W)  -> io.bn_batch_stride,
    //nvdla_sdp_rdma_d_bn_line_stride_0_out
    "h4c".asUInt(32.W)  -> io.bn_line_stride,
    //nvdla_sdp_rdma_d_bn_surface_stride_0_out
    "h50".asUInt(32.W)  -> io.bn_surface_stride,
    //nvdla_sdp_rdma_d_brdma_cfg_0_out
    "h28".asUInt(32.W)  -> Cat("b0".asUInt(26.W), io.brdma_ram_type, io.brdma_data_mode, io.brdma_data_size, io.brdma_data_use, io.brdma_disable),
    //nvdla_sdp_rdma_d_bs_base_addr_high_0_out
    "h30".asUInt(32.W)  -> io.bs_base_addr_high,
    //nvdla_sdp_rdma_d_bs_base_addr_low_0_out
    "h2c".asUInt(32.W)  -> io.bs_base_addr_low,
    //nvdla_sdp_rdma_d_bs_batch_stride_0_out
    "h3c".asUInt(32.W)  -> io.bs_batch_stride,
    //nvdla_sdp_rdma_d_bs_line_stride_0_out
    "h34".asUInt(32.W)  -> io.bs_line_stride,
    //nvdla_sdp_rdma_d_bs_surface_stride_0_out
    "h38".asUInt(32.W)  -> io.bs_surface_stride,
    ...
    "h0c".asUInt(32.W)  -> Cat("b0".asUInt(19.W), io.width_a), 
    //nvdla_sdp_rdma_d_erdma_cfg_0_out
    "h58".asUInt(32.W)  -> Cat("b0".asUInt(26.W), io.erdma_ram_type, io.erdma_data_mode, io.erdma_data_size, io.erdma_data_use, io.erdma_disable),
    //nvdla_sdp_rdma_d_ew_base_addr_high_0_out
    "h60".asUInt(32.W)  -> io.ew_base_addr_high, 
    //nvdla_sdp_rdma_d_ew_base_addr_low_0_out
    "h5c".asUInt(32.W)  -> io.ew_base_addr_low, 
    //nvdla_sdp_rdma_d_ew_batch_stride_0_out
    "h6c".asUInt(32.W)  -> io.ew_batch_stride, 
    //nvdla_sdp_rdma_d_ew_line_stride_0_out
    "h64".asUInt(32.W)  -> io.ew_line_stride, 
    //nvdla_sdp_rdma_d_ew_surface_stride_0_out
    "h68".asUInt(32.W)  -> io.ew_surface_stride, 
    //nvdla_sdp_rdma_d_feature_mode_cfg_0_out
    "h70".asUInt(32.W)  -> Cat("b0".asUInt(19.W), io.batch_number, io.out_precision, io.proc_precision, io.in_precision, io.winograd, io.flying_mode),
    //nvdla_sdp_rdma_d_nrdma_cfg_0_out
    "h40".asUInt(32.W)  -> Cat("b0".asUInt(26.W), io.nrdma_ram_type, io.nrdma_data_mode, io.nrdma_data_size, io.nrdma_data_use, io.nrdma_disable), 
    ...
    "h80".asUInt(32.W)  -> Cat("b0".asUInt(30.W), io.perf_nan_inf_count_en, io.perf_dma_en),
    ...
    "h74".asUInt(32.W)  -> Cat("b0".asUInt(31.W), io.src_ram_type),
