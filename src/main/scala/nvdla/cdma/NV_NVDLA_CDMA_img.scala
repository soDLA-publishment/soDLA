...
//     val img_dat2cvif_io = if(conf.NVDLA_SECONDARY_MEMIF_ENABLE) Some(IO(new Bundle{
...
//         val cvif2img_dat_rd_rsp_pd = Input(UInt(conf.NVDLA_CDMA_MEM_RD_REQ.W))
//     })) else None
...
//         img_dat2cvif_io.get.img_dat2cvif_rd_req_pd := u_sg.io.img_dat2cvif_rd_req_pd
//         img_dat2cvif_io.get.img_dat2cvif_rd_req_valid := u_sg.io.img_dat2cvif_rd_req_valid.get
//         u_sg.io.img_dat2cvif_rd_req_ready.get := img_dat2cvif_io.get.img_dat2cvif_rd_req_ready
//         u_sg.io.cvif2img_dat_rd_rsp_pd.get := img_dat2cvif_io.get.cvif2img_dat_rd_rsp_pd
//         u_sg.io.cvif2img_dat_rd_rsp_valid.get := img_dat2cvif_io.get.cvif2img_dat_rd_rsp_valid
//         img_dat2cvif_io.get.cvif2img_dat_rd_rsp_ready := u_sg.io.cvif2img_dat_rd_rsp_ready.get
//     }
