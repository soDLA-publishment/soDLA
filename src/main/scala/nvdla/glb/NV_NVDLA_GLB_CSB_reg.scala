...
withClock(io.nvdla_core_clk){
    ...
    val nvdla_glb_s_intr_mask_0_out = Cat("b0".asUInt(10.W), io.cacc_done_mask1, io.cacc_done_mask0, 
    ...
    val nvdla_glb_s_intr_set_0_out = Cat("b0".asUInt(10.W), io.cacc_done_set1, io.reg_offset, 
    ...
    val nvdla_glb_s_intr_status_0_out = Cat("b0".asUInt(10.W), io.cacc_done_status1, io.cacc_done_status0, 
    ...
    val nvdla_glb_s_nvdla_hw_version_0_out = Cat("b0".asUInt(8.W), minor, major)
    ...
    Seq(      
    "h4".asUInt(32.W)  -> nvdla_glb_s_intr_mask_0_out,
    "h8".asUInt(32.W)  -> nvdla_glb_s_intr_set_0_out,
    "hc".asUInt(32.W)  -> nvdla_glb_s_intr_status_0_out,
    "h0".asUInt(32.W)  -> nvdla_glb_s_nvdla_hw_version_0_out,                                                                             
    ))
