...
analyze -format sverilog -library impl {../../small_gate/vmod/nvdla/csc/NV_NVDLA_CSC_sg_wrapper.v
                                        ../../small_gate/vmod/nvdla/csc/NV_NVDLA_CSC_sg.v}

elaborate_seq -spectop NV_NVDLA_CSC_sg_golden_wrapper -impltop NV_NVDLA_CSC_sg_wrapper
