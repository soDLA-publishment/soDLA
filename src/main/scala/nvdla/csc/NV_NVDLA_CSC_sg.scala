...
//     val cur_channel = Mux(~is_last_channel, c_fetch_size(6, 0), io.reg2dp_weight_channel_ext(LOG2_ATOMC - 1, 0)+1.U)
...
//                                   Mux(io.reg2dp_y_extension === "h2".asUInt(2.W), (sg2dat_stripe_length + "h3".asUInt(2.W)) & "hfc".asUInt(7.W),
//                                   Mux(io.reg2dp_y_extension === "h1".asUInt(2.W), (sg2dat_stripe_length + "h1".asUInt(2.W)) & "hfe".asUInt(7.W)，
...
//     val pop_cnt_w = Mux((dat_pop_ready|wt_pop_ready), max_cycles, Mux()))
