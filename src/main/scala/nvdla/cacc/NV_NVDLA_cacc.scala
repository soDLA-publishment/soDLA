...
// class NV_NVDLA_cacc extends Module {
...
//         val mac_a2accu_data = Input(Vec(conf.CACC_ATOMK/2, SInt(CACC_IN_WIDTH.W)))
...
//         val mac_b2accu_data = Input(Vec(conf.CACC_ATOMK/2, SInt(CACC_IN_WIDTH.W)))
...
//     u_regfile.io.csb2cacc_req_pd := csb2cacc_req_pd               
//     u_regfile.io.csb2cacc_req_pvld := csb2cacc_req_pvld        
