...
//     val nvdla_sdp_rdma_d_data_cube_width_0_wren = (io.reg_offset === "h0c".asUInt(32.W)) & io.reg_wr_en ;  //spyglass disable UnloadedNet-ML //(W528)
...
//     val nvdla_sdp_rdma_d_data_cube_width_0_out = Cat("b0".asUInt(19.W), io.width)
...
//     "h0c".asUInt(32.W)  -> nvdla_sdp_rdma_d_data_cube_width_0_out, 
...
//     when(nvdla_sdp_rdma_d_data_cube_width_0_wren){
