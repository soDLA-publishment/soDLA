...
class NV_NVDLA_MCIF_READ_IG_cvt(implicit conf: nvdlaConfig) extends Module {
    ...
    withClock(io.nvdla_core_clk){
        ...
        val axi_addr = Cat(cmd_addr(conf.NVDLA_MEM_ADDRESS_WIDTH-1, conf.NVDLA_MEMORY_ATOMIC_LOG2), Fill(conf.NVDLA_MEMORY_ATOMIC_LOG2, false.B))
...
//
        ...
        val opipe_axi_pd = pipe_p1.io.dout
