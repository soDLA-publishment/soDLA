...
withClock(io.nvdla_core_clk){
    ...
    val roc_rd_pvld = u_roc.io.rd_pvld
    u_roc.io.rd_prdy := roc_rd_prdy
    val roc_rd_pd = u_roc.io.rd_pd
    ...
    io.sdp_rdma2dp_pd.valid := pipe_p1.io.vo
    pipe_p1.io.ri := io.sdp_rdma2dp_pd.ready
    io.sdp_rdma2dp_pd.bits := pipe_p1.io.dout
