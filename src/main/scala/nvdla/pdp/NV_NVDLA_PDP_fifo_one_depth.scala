...
// //NV_NVDLA_PDP_WDMA_CMD_fifo

// class NV_NVDLA_PDP_fifo_one_depth(width: Int) extends Module {
...
//     val wr_pvld_in = RegInit(false.B)    // registered wr_pvld_in
...
//     val wr_busy_in_next_wr_req_eq_0 = (wr_pvld_in && wr_busy_next) && !wr_reserving
//     val wr_busy_in_next = Mux(io.wr_pvld, wr_busy_in_next_wr_req_eq_1, wr_busy_in_next_wr_req_eq_0)
...
//     val ram = Module(new nv_flopram_internal_wr_reg(1, width))
//     ram.io.clk := io.clk
...
//     ram.io.we := ram_we
//     ram.io.wa := wr_adr
//     ram.io.ra := Mux(wr_count === 0.U, 1.U, 0.U)
