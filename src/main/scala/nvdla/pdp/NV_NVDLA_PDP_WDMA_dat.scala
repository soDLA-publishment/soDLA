...
// class NV_NVDLA_PDP_WDMA_dat(implicit val conf: pdpConfiguration) extends Module {
...
//         val dat_fifo_rd_pvld = Output(Vec(conf.CMAC_ATOMK_HALF, Vec(conf.CMAC_ATOMC, conf.CMAC_TYPE(conf.CMAC_BPE.W))))
