...
class int_sum_block_tp1(implicit conf: cdpConfiguration) extends Module {
    ...
    //Reg
    io.int8_sum := Reg(UInt(pINT8_BW*2+3).W)
    val int8_sum3 = Reg(UInt(pINT8_BW*2+1).W)
    val int8_sum5 = Reg(UInt(pINT8_BW*2+2).W)
    val int8_sum7 = Reg(UInt(pINT8_BW*2+2).W)
    val int8_sum9 = Reg(UInt(pINT8_BW*2+2).W)

        //add from double sides
    val int8_sum_0_8 = Reg(UInt(pINT8_BW*2).W)
    val int8_sum_1_7 = Reg(UInt(pINT8_BW*2).W)
    val int8_sum_2_6 = Reg(UInt(pINT8_BW*2).W)
    val int8_sum_3_5 = Reg(UInt(pINT8_BW*2).W)
    val sq_pd_int8_4_d = Reg(UInt(pINT8_BW*2-1).W)
