...
withClock(io.nvdla_core_clk){
    ...
    io.alu_data_out.valid := Mux(io.cfg_alu_bypass, io.alu_data_in.valid, alu_final_pvld)
    io.alu_data_out.bits := Mux(io.cfg_alu_bypass, io.alu_data_in.bits, alu_data_final)
