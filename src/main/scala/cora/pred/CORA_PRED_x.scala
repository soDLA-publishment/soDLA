...
//             └──┴──┘       └──┴──┘ 
    ...
    //Hardware Reuse
    //clock counter
    val pre_x_valid = io.stat_x_actv_pvld & io.mat_f_actv_pvld & io.stat_u_actv_pvld 
    val pre_x_valid_d1 = RegNext(pre_x_valid, false.B)
    val pre_x_st = ~pre_x_valid_d1 & pre_x_valid
