...
//         val reg2dp_bn = if(conf.NVDLA_SDP_BN_ENABLE) Some(Flipped(new sdp_core_b_cfg_if)) else None

//         //ifdef NVDLA_SDP_BS_ENABLE
//         val reg2dp_bs = if(conf.NVDLA_SDP_BS_ENABLE) Some(Flipped(new sdp_core_b_cfg_if)) else None

//         val reg2dp_cvt = Flipped(new c_int_cfg_if)
//         val reg2dp_ecore_slcg_op_en = Input(Bool())

//         //ifdef NVDLA_SDP_EW_ENABLE
//         val reg2dp_ew = if(conf.NVDLA_SDP_EW_ENABLE) Some(Flipped(new sdp_core_ew_if)) else None
//         val reg2dp_lut = if(conf.NVDLA_SDP_EW_ENABLE&conf.NVDLA_SDP_LUT_ENABLE) Some(Flipped(new sdp_core_y_lut_reg2dp_if)) else None
//         val dp2reg_lut = if(conf.NVDLA_SDP_EW_ENABLE&conf.NVDLA_SDP_LUT_ENABLE) Some(new sdp_core_y_lut_dp2reg_if) else None
//         val reg2dp_idx = if(conf.NVDLA_SDP_LUT_ENABLE&conf.NVDLA_SDP_LUT_ENABLE) Some(Flipped(new sdp_idx_cfg_if)) else None
...
//         cfg_bs_en := io.reg2dp_bs.get.bypass === 0.U
//     }
//     else{
//         cfg_bs_en := false.B
//     }
...
//         cfg_bn_en := io.reg2dp_bn.get.bypass === 0.U
//     }
//     else{
//         cfg_bn_en := false.B
//     }
...
//         cfg_ew_en := io.reg2dp_ew.get.bypass === 0.U
//         cfg_mode_eql := (io.reg2dp_ew.get.alu_algo === 3.U) && 
//                         (io.reg2dp_ew.get.alu_bypass === 0.U) && 
//                         (io.reg2dp_ew.get.bypass === 0.U)
//     }
//     else{
//         cfg_bs_en := false.B
...
//     when(op_en_load){
//         if(conf.NVDLA_SDP_BS_ENABLE){
//             cfg_bs_alu_operand.get      := io.reg2dp_bs.get.alu_operand      
//             cfg_bs_mul_operand.get      := io.reg2dp_bs.get.mul_operand     
//             cfg_bs_alu_bypass.get       := io.reg2dp_bs.get.alu_bypass       
//             cfg_bs_alu_algo.get         := io.reg2dp_bs.get.alu_algo         
//             cfg_bs_alu_src.get          := io.reg2dp_bs.get.alu_src         
//             cfg_bs_alu_shift_value.get  := io.reg2dp_bs.get.alu_shift_value  
//             cfg_bs_mul_bypass.get       := io.reg2dp_bs.get.mul_bypass      
//             cfg_bs_mul_prelu.get        := io.reg2dp_bs.get.mul_prelu        
//             cfg_bs_mul_src.get          := io.reg2dp_bs.get.mul_src          
//             cfg_bs_mul_shift_value.get  := io.reg2dp_bs.get.mul_shift_value  
//             cfg_bs_relu_bypass.get      := io.reg2dp_bs.get.relu_bypass                 
//         }
//         if(conf.NVDLA_SDP_BN_ENABLE){
//             cfg_bn_alu_operand.get      := io.reg2dp_bn.get.alu_operand      
//             cfg_bn_mul_operand.get      := io.reg2dp_bn.get.mul_operand      
//             cfg_bn_alu_bypass.get       := io.reg2dp_bn.get.alu_bypass      
//             cfg_bn_alu_algo.get         := io.reg2dp_bn.get.alu_algo      
//             cfg_bn_alu_src.get          := io.reg2dp_bn.get.alu_src         
//             cfg_bn_alu_shift_value.get  := io.reg2dp_bn.get.alu_shift_value  
//             cfg_bn_mul_bypass.get       := io.reg2dp_bn.get.mul_bypass      
//             cfg_bn_mul_prelu.get        := io.reg2dp_bn.get.mul_prelu      
//             cfg_bn_mul_src.get          := io.reg2dp_bn.get.mul_src        
//             cfg_bn_mul_shift_value.get  := io.reg2dp_bn.get.mul_shift_value  
//             cfg_bn_relu_bypass.get      := io.reg2dp_bn.get.relu_bypass      
//         }      
...
//         }
//         .elsewhen(op_en_load){
//             bs_alu_in_en.get := cfg_bs_en && (!io.reg2dp_bs.get.alu_bypass) && (io.reg2dp_bs.get.alu_src===1.U)
//             bs_mul_in_en.get := cfg_bs_en && (!io.reg2dp_bs.get.mul_bypass) && (io.reg2dp_bs.get.mul_src===1.U)
//         }
...
//         }
//         .elsewhen(op_en_load){
//             bn_alu_in_en.get := cfg_bn_en && (!io.reg2dp_bn.get.alu_bypass) && (io.reg2dp_bn.get.alu_src===1.U)
//             bn_mul_in_en.get := cfg_bn_en && (!io.reg2dp_bn.get.mul_bypass) && (io.reg2dp_bn.get.mul_src===1.U)
//         }
...
//         }
//         .elsewhen(op_en_load){
//             ew_alu_in_en.get := cfg_ew_en && (!io.reg2dp_ew.get.alu_bypass) && (io.reg2dp_ew.get.alu_src===1.U)
//             ew_mul_in_en.get := cfg_ew_en && (!io.reg2dp_ew.get.mul_bypass) && (io.reg2dp_ew.get.mul_src===1.U)
//         }
...
//         u_bs.get.io.cfg.alu_algo := cfg_bs_alu_algo.get
//         u_bs.get.io.cfg.alu_bypass := cfg_bs_alu_bypass.get
//         u_bs.get.io.cfg.alu_op := cfg_bs_alu_operand.get
//         u_bs.get.io.cfg.alu_shift_value := cfg_bs_alu_shift_value.get
//         u_bs.get.io.cfg.alu_src := cfg_bs_alu_src.get
//         u_bs.get.io.cfg.mul_bypass := cfg_bs_mul_bypass.get
//         u_bs.get.io.cfg.mul_op := cfg_bs_mul_operand.get
//         u_bs.get.io.cfg.mul_prelu := cfg_bs_mul_prelu.get
//         u_bs.get.io.cfg.mul_shift_value := cfg_bs_mul_shift_value.get
//         u_bs.get.io.cfg.mul_src := cfg_bs_mul_src.get
//         u_bs.get.io.cfg.relu_bypass := cfg_bs_relu_bypass.get  
...
//         u_bn.get.io.cfg.alu_algo := cfg_bn_alu_algo.get
//         u_bn.get.io.cfg.alu_bypass := cfg_bn_alu_bypass.get
//         u_bn.get.io.cfg.alu_op := cfg_bn_alu_operand.get
//         u_bn.get.io.cfg.alu_shift_value := cfg_bn_alu_shift_value.get
//         u_bn.get.io.cfg.alu_src := cfg_bn_alu_src.get
//         u_bn.get.io.cfg.mul_bypass := cfg_bn_mul_bypass.get
//         u_bn.get.io.cfg.mul_op := cfg_bn_mul_operand.get
//         u_bn.get.io.cfg.mul_prelu := cfg_bn_mul_prelu.get
//         u_bn.get.io.cfg.mul_shift_value := cfg_bn_mul_shift_value.get
//         u_bn.get.io.cfg.mul_src := cfg_bn_mul_src.get
//         u_bn.get.io.cfg.relu_bypass := cfg_bn_relu_bypass.get 
...
//     u_c.io.cfg.offset := cfg_cvt_offset
//     u_c.io.cfg_out_precision := cfg_out_precision
//     u_c.io.cfg.scale := cfg_cvt_scale
//     u_c.io.cfg.truncate := cfg_cvt_shift
