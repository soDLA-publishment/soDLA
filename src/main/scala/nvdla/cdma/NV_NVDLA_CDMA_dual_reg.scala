...
class NV_NVDLA_CDMA_dual_reg extends Module{
    ...
    // Address decode
    val nvdla_cdma_d_bank_0_wren = (io.reg.offset === "hbc".asUInt(32.W)) & io.reg_wr_en 
    val nvdla_cdma_d_batch_number_0_wren = (io.reg.offset === "h58".asUInt(32.W)) & io.reg_wr_en 
    val nvdla_cdma_d_batch_stride_0_wren = (io.reg.offset === "h5c".asUInt(32.W)) & io.reg_wr_en 
    val nvdla_cdma_d_conv_stride_0_wren = (io.reg.offset === "hb0".asUInt(32.W)) & io.reg_wr_en 
    val nvdla_cdma_d_cvt_cfg_0_wren = (io.reg.offset === "ha4".asUInt(32.W)) & io.reg_wr_en 
    val nvdla_cdma_d_cvt_offset_0_wren = (io.reg.offset === "ha8".asUInt(32.W)) & io.reg_wr_en 
    val nvdla_cdma_d_cvt_scale_0_wren = (io.reg.offset === "hac".asUInt(32.W)) & io.reg_wr_en 
    val nvdla_cdma_d_cya_0_wren = (io.reg.offset === "he8".asUInt(32.W)) & io.reg_wr_en 
    val nvdla_cdma_d_dain_addr_high_0_0_wren = (io.reg.offset === "h30".asUInt(32.W)) & io.reg_wr_en 
    val nvdla_cdma_d_dain_addr_high_1_0_wren = (io.reg.offset === "h38".asUInt(32.W)) & io.reg_wr_en 
    val nvdla_cdma_d_dain_addr_low_0_0_wren = (io.reg.offset === "h34".asUInt(32.W)) & io.reg_wr_en 
    val nvdla_cdma_d_dain_addr_low_1_0_wren = (io.reg.offset === "h3c".asUInt(32.W)) & io.reg_wr_en 
    val nvdla_cdma_d_dain_map_0_wren = (io.reg.offset === "h4c".asUInt(32.W)) & io.reg_wr_en 
    val nvdla_cdma_d_dain_ram_type_0_wren = (io.reg.offset === "h2c".asUInt(32.W)) & io.reg_wr_en 
    val nvdla_cdma_d_datain_format_0_wren = (io.reg.offset === "h18".asUInt(32.W)) & io.reg_wr_en 
    val nvdla_cdma_d_datain_size_0_0_wren = (io.reg.offset === "h1c".asUInt(32.W)) & io.reg_wr_en 
    val nvdla_cdma_d_datain_size_1_0_wren = (io.reg.offset === "h20".asUInt(32.W)) & io.reg_wr_en 
    val nvdla_cdma_d_datain_size_ext_0_0_wren = (io.reg.offset === "h24".asUInt(32.W)) & io.reg_wr_en 
    val nvdla_cdma_d_entry_per_slice_0_wren = (io.reg.offset === "h60".asUInt(32.W)) & io.reg_wr_en 
    val nvdla_cdma_d_fetch_grain_0_wren = (io.reg.offset === "h64".asUInt(32.W)) & io.reg_wr_en 
    val nvdla_cdma_d_inf_input_data_num_0_wren = (io.reg.offset === "hcc".asUInt(32.W)) & io.reg_wr_en 
    val nvdla_cdma_d_inf_input_weight_num_0_wren = (io.reg.offset === "hd0".asUInt(32.W)) & io.reg_wr_en 
    val nvdla_cdma_d_line_stride_0_wren = (io.reg.offset === "h40".asUInt(32.W)) & io.reg_wr_en 
    val nvdla_cdma_d_line_uv_stride_0_wren = (io.reg.offset === "h44".asUInt(32.W)) & io.reg_wr_en 
    val nvdla_cdma_d_mean_format_0_wren = (io.reg.offset === "h98".asUInt(32.W)) & io.reg_wr_en 
    val nvdla_cdma_d_mean_global_0_0_wren = (io.reg.offset === "h9c".asUInt(32.W)) & io.reg_wr_en 
    val nvdla_cdma_d_mean_global_1_0_wren = (io.reg.offset === "ha0".asUInt(32.W)) & io.reg_wr_en 
    val nvdla_cdma_d_misc_cfg_0_wren = (io.reg.offset === "h14".asUInt(32.W)) & io.reg_wr_en 
    val nvdla_cdma_d_nan_flush_to_zero_0_wren = (io.reg.offset === "hc0".asUInt(32.W)) & io.reg_wr_en 
    val nvdla_cdma_d_nan_input_data_num_0_wren = (io.reg.offset === "hc4".asUInt(32.W)) & io.reg_wr_en 
    val nvdla_cdma_d_nan_input_weight_num_0_wren = (io.reg.offset === "hc8".asUInt(32.W)) & io.reg_wr_en 
    val nvdla_cdma_d_op_enable_0_wren = (io.reg.offset === "h10".asUInt(32.W)) & io.reg_wr_en 
    val nvdla_cdma_d_perf_dat_read_latency_0_wren = (io.reg.offset === "he0".asUInt(32.W)) & io.reg_wr_en 
    val nvdla_cdma_d_perf_dat_read_stall_0_wren = (io.reg.offset === "hd8".asUInt(32.W)) & io.reg_wr_en 
    val nvdla_cdma_d_perf_enable_0_wren = (io.reg.offset === "hd4".asUInt(32.W)) & io.reg_wr_en 
    val nvdla_cdma_d_perf_wt_read_latency_0_wren = (io.reg.offset === "he4".asUInt(32.W)) & io.reg_wr_en 
    val nvdla_cdma_d_perf_wt_read_stall_0_wren = (io.reg.offset === "hdc".asUInt(32.W)) & io.reg_wr_en 
    val nvdla_cdma_d_pixel_offset_0_wren = (io.reg.offset === "h28".asUInt(32.W)) & io.reg_wr_en 
    val nvdla_cdma_d_reserved_x_cfg_0_wren = (io.reg.offset === "h50".asUInt(32.W)) & io.reg_wr_en 
    val nvdla_cdma_d_reserved_y_cfg_0_wren = (io.reg.offset === "h54".asUInt(32.W)) & io.reg_wr_en 
    val nvdla_cdma_d_surf_stride_0_wren = (io.reg.offset === "h48".asUInt(32.W)) & io.reg_wr_en 
    val nvdla_cdma_d_weight_addr_high_0_wren = (io.reg.offset === "h78".asUInt(32.W)) & io.reg_wr_en 
    val nvdla_cdma_d_weight_addr_low_0_wren = (io.reg.offset === "h7c".asUInt(32.W)) & io.reg_wr_en 
    val nvdla_cdma_d_weight_bytes_0_wren = (io.reg.offset === "h80".asUInt(32.W)) & io.reg_wr_en 
    val nvdla_cdma_d_weight_format_0_wren = (io.reg.offset === "h68".asUInt(32.W)) & io.reg_wr_en 
    val nvdla_cdma_d_weight_ram_type_0_wren = (io.reg.offset === "h74".asUInt(32.W)) & io.reg_wr_en 
    val nvdla_cdma_d_weight_size_0_0_wren = (io.reg.offset === "h6c".asUInt(32.W)) & io.reg_wr_en 
    val nvdla_cdma_d_weight_size_1_0_wren = (io.reg.offset === "h70".asUInt(32.W)) & io.reg_wr_en 
    val nvdla_cdma_d_wgs_addr_high_0_wren = (io.reg.offset === "h84".asUInt(32.W)) & io.reg_wr_en 
    val nvdla_cdma_d_wgs_addr_low_0_wren = (io.reg.offset === "h88".asUInt(32.W)) & io.reg_wr_en 
    val nvdla_cdma_d_wmb_addr_high_0_wren = (io.reg.offset === "h8c".asUInt(32.W)) & io.reg_wr_en 
    val nvdla_cdma_d_wmb_addr_low_0_wren = (io.reg.offset === "h90".asUInt(32.W)) & io.reg_wr_en 
    val nvdla_cdma_d_wmb_bytes_0_wren = (io.reg.offset === "h94".asUInt(32.W)) & io.reg_wr_en 
    val nvdla_cdma_d_zero_padding_0_wren = (io.reg.offset === "hb4".asUInt(32.W)) & io.reg_wr_en 
    val nvdla_cdma_d_zero_padding_value_0_wren = (io.reg.offset === "hb8".asUInt(32.W)) & io.reg_wr_en 
