...
@chiselName
class NV_NVDLA_SDP_HLS_lut_expn(LUT_DEPTH:Int = 256)(implicit conf: nvdlaConfig) extends Module {
...
withClock(io.nvdla_core_clk){
    val lut_uflow_in = io.idx_in.bits.asSInt <= io.cfg_lut_start.asSInt
    val lut_index_sub_tmp = (io.idx_in.bits.asSInt - io.cfg_lut_start.asSInt).asUInt
