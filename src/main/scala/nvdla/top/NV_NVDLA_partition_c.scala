...
//     val cdma2cvif_io = if(conf.NVDLA_SECONDARY_MEMIF_ENABLE) Some(IO(new Bundle {
...
//         val cdma_wt2cvif_rd_req_valid = Output(Bool())
//         val cdma_wt2cvif_rd_req_ready = Input(Bool())
//         val cdma_wt2cvif_rd_req_pd = Output(UInt(conf.NVDLA_CDMA_MEM_RD_REQ.W))
//         val cvif2cdma_wt_rd_rsp_valid = Input(Bool())
//         val cvif2cdma_wt_rd_rsp_ready = Output(Bool())
//         val cvif2cdma_wt_rd_rsp_pd = Input(UInt(conf.NVDLA_CDMA_MEM_RD_RSP.W))
