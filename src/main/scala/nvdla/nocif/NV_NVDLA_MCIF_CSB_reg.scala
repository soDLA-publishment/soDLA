...
withClock(io.nvdla_core_clk){
    ...
    "h00".asUInt(32.W)  -> Cat(io.field.rd_weight_cdp, io.field.rd_weight_pdp, io.field.rd_weight_sdp, io.field.rd_weight_bdma),
    //nvdla_mcif_cfg_rd_weight_1_0_out
    "h04".asUInt(32.W)  -> Cat(io.field.rd_weight_cdma_dat, io.field.rd_weight_sdp_e, io.field.rd_weight_sdp_n, io.field.rd_weight_sdp_b),
    //nvdla_mcif_cfg_rd_weight_2_0_out
    "h08".asUInt(32.W)  -> Cat(io.field.rd_weight_rsv_0, io.field.rd_weight_rsv_1, io.field.rd_weight_rbk, io.field.rd_weight_cdma_wt),
    //nvdla_mcif_cfg_wr_weight_0_0_out
    "h0c".asUInt(32.W)  -> Cat(io.field.wr_weight_cdp, io.field.wr_weight_pdp, io.field.wr_weight_sdp, io.field.wr_weight_bdma),
    //nvdla_mcif_cfg_wr_weight_1_0_out
    "h10".asUInt(32.W)  -> Cat(io.field.wr_weight_rsv_0, io.field.wr_weight_rsv_1, io.field.wr_weight_rsv_2, io.field.wr_weight_rbk),
    ...
    io.field.rd_weight_bdma := RegEnable(io.reg.wr_data(7, 0), "b00000001".asUInt(8.W), nvdla_mcif_cfg_rd_weight_0_0_wren)
    // Register: NVDLA_MCIF_CFG_RD_WEIGHT_0_0    Field: rd_weight_cdp
    io.field.rd_weight_cdp := RegEnable(io.reg.wr_data(31, 24), "b00000001".asUInt(8.W), nvdla_mcif_cfg_rd_weight_0_0_wren)
    // Register: NVDLA_MCIF_CFG_RD_WEIGHT_0_0    Field: rd_weight_pdp
    io.field.rd_weight_pdp := RegEnable(io.reg.wr_data(23, 16), "b00000001".asUInt(8.W), nvdla_mcif_cfg_rd_weight_0_0_wren)
    // Register: NVDLA_MCIF_CFG_RD_WEIGHT_0_0    Field: rd_weight_sdp
    io.field.rd_weight_sdp := RegEnable(io.reg.wr_data(15, 8), "b00000001".asUInt(8.W), nvdla_mcif_cfg_rd_weight_0_0_wren)
    // Register: NVDLA_MCIF_CFG_RD_WEIGHT_1_0    Field: rd_weight_cdma_dat
    io.field.rd_weight_cdma_dat := RegEnable(io.reg.wr_data(31, 24), "b00000001".asUInt(8.W), nvdla_mcif_cfg_rd_weight_1_0_wren)
    // Register: NVDLA_MCIF_CFG_RD_WEIGHT_1_0    Field: rd_weight_sdp_b
    io.field.rd_weight_sdp_b := RegEnable(io.reg.wr_data(7, 0), "b00000001".asUInt(8.W), nvdla_mcif_cfg_rd_weight_1_0_wren)
    // Register: NVDLA_MCIF_CFG_RD_WEIGHT_1_0    Field: rd_weight_sdp_e
    io.field.rd_weight_sdp_e := RegEnable(io.reg.wr_data(23, 16), "b00000001".asUInt(8.W), nvdla_mcif_cfg_rd_weight_1_0_wren)
    // Register: NVDLA_MCIF_CFG_RD_WEIGHT_1_0    Field: rd_weight_sdp_n
    io.field.rd_weight_sdp_n := RegEnable(io.reg.wr_data(15, 8), "b00000001".asUInt(8.W), nvdla_mcif_cfg_rd_weight_1_0_wren)
    // Register: NVDLA_MCIF_CFG_RD_WEIGHT_2_0    Field: rd_weight_cdma_wt
    io.field.rd_weight_cdma_wt := RegEnable(io.reg.wr_data(7, 0), "b00000001".asUInt(8.W), nvdla_mcif_cfg_rd_weight_2_0_wren)
    // Register: NVDLA_MCIF_CFG_RD_WEIGHT_2_0    Field: rd_weight_rbk
    io.field.rd_weight_rbk := RegEnable(io.reg.wr_data(15, 8), "b00000001".asUInt(8.W), nvdla_mcif_cfg_rd_weight_2_0_wren)
    ...
    io.field.wr_weight_bdma := RegEnable(io.reg.wr_data(7, 0), "b00000001".asUInt(8.W), nvdla_mcif_cfg_wr_weight_0_0_wren)
    // Register: NVDLA_MCIF_CFG_WR_WEIGHT_0_0    Field: wr_weight_cdp
    io.field.wr_weight_cdp := RegEnable(io.reg.wr_data(31, 24), "b00000001".asUInt(8.W), nvdla_mcif_cfg_wr_weight_0_0_wren)
    // Register: NVDLA_MCIF_CFG_WR_WEIGHT_0_0    Field: wr_weight_pdp
    io.field.wr_weight_pdp := RegEnable(io.reg.wr_data(23, 16), "b00000001".asUInt(8.W), nvdla_mcif_cfg_wr_weight_0_0_wren)
    // Register: NVDLA_MCIF_CFG_WR_WEIGHT_0_0    Field: wr_weight_sdp
    io.field.wr_weight_sdp := RegEnable(io.reg.wr_data(15, 8), "b00000001".asUInt(8.W), nvdla_mcif_cfg_wr_weight_0_0_wren)
    // Register: NVDLA_MCIF_CFG_WR_WEIGHT_1_0    Field: wr_weight_rbk
    io.field.wr_weight_rbk := RegEnable(io.reg.wr_data(7, 0), "b00000001".asUInt(8.W), nvdla_mcif_cfg_wr_weight_1_0_wren)
