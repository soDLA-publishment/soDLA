...
analyze -format sverilog -library impl {../../small_gate/vmod/nvdla/csc/NV_NVDLA_CSC_dl_wrapper.v
                                        ../../small_gate/vmod/nvdla/csc/NV_NVDLA_CSC_dl.v}

elaborate_seq -spectop NV_NVDLA_CSC_dl_golden_wrapper -impltop NV_NVDLA_CSC_dl_wrapper
