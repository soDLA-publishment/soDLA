...
class NV_NVDLA_SDP_REG_dual extends Module{
    ...
    // Address decode
    val nvdla_sdp_d_cvt_offset_0_wren = (io.reg.offset === "hc0".asUInt(32.W)) & io.reg_wr_en ;   
    val nvdla_sdp_d_cvt_scale_0_wren = (io.reg.offset ===  "hc4".asUInt(32.W)) & io.reg_wr_en ;   
    val nvdla_sdp_d_cvt_shift_0_wren = (io.reg.offset ===  "hc8".asUInt(32.W)) & io.reg_wr_en ;   
    val nvdla_sdp_d_data_cube_channel_0_wren = (io.reg.offset ===  "h44".asUInt(32.W)) & io.reg_wr_en ;   
    val nvdla_sdp_d_data_cube_height_0_wren = (io.reg.offset === "h40".asUInt(32.W)) & io.reg_wr_en ;   
    val nvdla_sdp_d_data_cube_width_0_wren = (io.reg.offset === "h3c".asUInt(32.W)) & io.reg_wr_en ;   
    val nvdla_sdp_d_data_format_0_wren = (io.reg.offset === "hbc".asUInt(32.W)) & io.reg_wr_en ;   
    val nvdla_sdp_d_dp_bn_alu_cfg_0_wren = (io.reg.offset === "h70".asUInt(32.W)) & io.reg_wr_en ;   
    val nvdla_sdp_d_dp_bn_alu_src_value_0_wren = (io.reg.offset === "h74".asUInt(32.W)) & io.reg_wr_en ;   
    val nvdla_sdp_d_dp_bn_cfg_0_wren = (io.reg.offset === "h6c".asUInt(32.W)) & io.reg_wr_en ;   
    val nvdla_sdp_d_dp_bn_mul_cfg_0_wren = (io.reg.offset === "h78".asUInt(32.W)) & io.reg_wr_en ;   
    val nvdla_sdp_d_dp_bn_mul_src_value_0_wren = (io.reg.offset === "h7c".asUInt(32.W)) & io.reg_wr_en ;   
    val nvdla_sdp_d_dp_bs_alu_cfg_0_wren = (io.reg.offset === "h5c".asUInt(32.W)) & io.reg_wr_en ;   
    val nvdla_sdp_d_dp_bs_alu_src_value_0_wren = (io.reg.offset === "h60".asUInt(32.W)) & io.reg_wr_en ;   
    val nvdla_sdp_d_dp_bs_cfg_0_wren = (io.reg.offset === "h58".asUInt(32.W)) & io.reg_wr_en ;   
    val nvdla_sdp_d_dp_bs_mul_cfg_0_wren = (io.reg.offset === "h64".asUInt(32.W)) & io.reg_wr_en ;   
    val nvdla_sdp_d_dp_bs_mul_src_value_0_wren = (io.reg.offset === "h68".asUInt(32.W)) & io.reg_wr_en ;   
    val nvdla_sdp_d_dp_ew_alu_cfg_0_wren = (io.reg.offset === "h84".asUInt(32.W)) & io.reg_wr_en ;   
    val nvdla_sdp_d_dp_ew_alu_cvt_offset_value_0_wren = (io.reg.offset === "h8c".asUInt(32.W)) & io.reg_wr_en ;   
    val nvdla_sdp_d_dp_ew_alu_cvt_scale_value_0_wren = (io.reg.offset === "h90".asUInt(32.W)) & io.reg_wr_en ;   
    val nvdla_sdp_d_dp_ew_alu_cvt_truncate_value_0_wren = (io.reg.offset === "h94".asUInt(32.W)) & io.reg_wr_en ;   
    val nvdla_sdp_d_dp_ew_alu_src_value_0_wren = (io.reg.offset === "h88".asUInt(32.W)) & io.reg_wr_en ;   
    val nvdla_sdp_d_dp_ew_cfg_0_wren = (io.reg.offset === "h80".asUInt(32.W)) & io.reg_wr_en ;   
    val nvdla_sdp_d_dp_ew_mul_cfg_0_wren = (io.reg.offset === "h98".asUInt(32.W)) & io.reg_wr_en ;   
    val nvdla_sdp_d_dp_ew_mul_cvt_offset_value_0_wren = (io.reg.offset === "ha0".asUInt(32.W)) & io.reg_wr_en ;   
    val nvdla_sdp_d_dp_ew_mul_cvt_scale_value_0_wren = (io.reg.offset === "ha4".asUInt(32.W)) & io.reg_wr_en ;   
    val nvdla_sdp_d_dp_ew_mul_cvt_truncate_value_0_wren = (io.reg.offset === "ha8".asUInt(32.W)) & io.reg_wr_en ;   
    val nvdla_sdp_d_dp_ew_mul_src_value_0_wren = (io.reg.offset === "h9c".asUInt(32.W)) & io.reg_wr_en ;   
    val nvdla_sdp_d_dp_ew_truncate_value_0_wren = (io.reg.offset === "hac".asUInt(32.W)) & io.reg_wr_en ;   
    val nvdla_sdp_d_dst_base_addr_high_0_wren = (io.reg.offset === "h4c".asUInt(32.W)) & io.reg_wr_en ;   
    val nvdla_sdp_d_dst_base_addr_low_0_wren = (io.reg.offset === "h48".asUInt(32.W)) & io.reg_wr_en ;   
    val nvdla_sdp_d_dst_batch_stride_0_wren = (io.reg.offset === "hb8".asUInt(32.W)) & io.reg_wr_en ;   
    val nvdla_sdp_d_dst_dma_cfg_0_wren = (io.reg.offset === "hb4".asUInt(32.W)) & io.reg_wr_en ;   
    val nvdla_sdp_d_dst_line_stride_0_wren = (io.reg.offset === "h50".asUInt(32.W)) & io.reg_wr_en ;   
    val nvdla_sdp_d_dst_surface_stride_0_wren = (io.reg.offset === "h54".asUInt(32.W)) & io.reg_wr_en ;   
    val nvdla_sdp_d_feature_mode_cfg_0_wren = (io.reg.offset === "hb0".asUInt(32.W)) & io.reg_wr_en ;   
    val nvdla_sdp_d_op_enable_0_wren = (io.reg.offset === "h38".asUInt(32.W)) & io.reg_wr_en ;   
    val nvdla_sdp_d_perf_enable_0_wren = (io.reg.offset === "hdc".asUInt(32.W)) & io.reg_wr_en ;   
    val nvdla_sdp_d_perf_lut_hybrid_0_wren = (io.reg.offset === "hf0".asUInt(32.W)) & io.reg_wr_en ;   
    val nvdla_sdp_d_perf_lut_le_hit_0_wren = (io.reg.offset === "hf4".asUInt(32.W)) & io.reg_wr_en ;   
    val nvdla_sdp_d_perf_lut_lo_hit_0_wren = (io.reg.offset === "hf8".asUInt(32.W)) & io.reg_wr_en ;   
    val nvdla_sdp_d_perf_lut_oflow_0_wren = (io.reg.offset === "he8".asUInt(32.W)) & io.reg_wr_en ;   
    val nvdla_sdp_d_perf_lut_uflow_0_wren = (io.reg.offset === "he4".asUInt(32.W)) & io.reg_wr_en ;   
    val nvdla_sdp_d_perf_out_saturation_0_wren = (io.reg.offset === "hec".asUInt(32.W)) & io.reg_wr_en ;   
    val nvdla_sdp_d_perf_wdma_write_stall_0_wren = (io.reg.offset === "he0".asUInt(32.W)) & io.reg_wr_en ;   
    val nvdla_sdp_d_status_0_wren = (io.reg.offset === "hcc".asUInt(32.W)) & io.reg_wr_en ;   
    val nvdla_sdp_d_status_inf_input_num_0_wren = (io.reg.offset === "hd4".asUInt(32.W)) & io.reg_wr_en ;   
    val nvdla_sdp_d_status_nan_input_num_0_wren = (io.reg.offset === "hd0".asUInt(32.W)) & io.reg_wr_en ;   
    val nvdla_sdp_d_status_nan_output_num_0_wren = (io.reg.offset === "hd8".asUInt(32.W)) & io.reg_wr_en ;   
