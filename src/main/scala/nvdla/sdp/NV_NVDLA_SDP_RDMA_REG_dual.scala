...
class NV_NVDLA_SDP_RDMA_REG_dual extends Module{
    ...
    "h88".asUInt(32.W)  -> io.brdma_stall,
    ...
    "h90".asUInt(32.W)  -> io.erdma_stall,
    //nvdla_sdp_rdma_d_perf_mrdma_read_stall_0_out
    "h84".asUInt(32.W)  -> io.mrdma_stall,
    //nvdla_sdp_rdma_d_perf_nrdma_read_stall_0_out
    "h8c".asUInt(32.W)  -> io.nrdma_stall,
    ...
    "h7c".asUInt(32.W)  -> io.status_inf_input_num,
    //nvdla_sdp_rdma_d_status_nan_input_num_0_out
    "h78".asUInt(32.W)  -> io.status_nan_input_num                                                                              
    ))
    ...
    io.field.bn_base_addr_high := RegEnable(io.reg.wr_data, "b0".asUInt(32.W), nvdla_sdp_rdma_d_bn_base_addr_high_0_wren)
    // Register: NVDLA_SDP_RDMA_D_BN_BASE_ADDR_LOW_0    Field: bn_base_addr_low
    io.field.bn_base_addr_low := RegEnable(io.reg.wr_data, "b0".asUInt(32.W), nvdla_sdp_rdma_d_bn_base_addr_low_0_wren)
    // Register: NVDLA_SDP_RDMA_D_BN_BATCH_STRIDE_0    Field: bn_batch_stride
    io.field.bn_batch_stride := RegEnable(io.reg.wr_data, "b0".asUInt(32.W), nvdla_sdp_rdma_d_bn_batch_stride_0_wren)
    // Register: NVDLA_SDP_RDMA_D_BN_LINE_STRIDE_0    Field: bn_line_stride
    io.field.bn_line_stride := RegEnable(io.reg.wr_data, "b0".asUInt(32.W), nvdla_sdp_rdma_d_bn_line_stride_0_wren)
    // Register: NVDLA_SDP_RDMA_D_BN_SURFACE_STRIDE_0    Field: bn_surface_stride
    io.field.bn_surface_stride := RegEnable(io.reg.wr_data, "b0".asUInt(32.W), nvdla_sdp_rdma_d_bn_surface_stride_0_wren)
    // Register: NVDLA_SDP_RDMA_D_BRDMA_CFG_0    Field: brdma_data_mode
    io.field.brdma_data_mode := RegEnable(io.reg.wr_data(4), false.B, nvdla_sdp_rdma_d_brdma_cfg_0_wren)
    // Register: NVDLA_SDP_RDMA_D_BRDMA_CFG_0    Field: brdma_data_size
    io.field.brdma_data_size := RegEnable(io.reg.wr_data(3), false.B, nvdla_sdp_rdma_d_brdma_cfg_0_wren)
    // Register: NVDLA_SDP_RDMA_D_BRDMA_CFG_0    Field: brdma_data_use
    io.field.brdma_data_use := RegEnable(io.reg.wr_data(2, 1), "b00".asUInt(2.W), nvdla_sdp_rdma_d_brdma_cfg_0_wren)
    // Register: NVDLA_SDP_RDMA_D_BRDMA_CFG_0    Field: brdma_disable
    io.field.brdma_disable := RegEnable(io.reg.wr_data(0), true.B, nvdla_sdp_rdma_d_brdma_cfg_0_wren)
    // Register: NVDLA_SDP_RDMA_D_BRDMA_CFG_0    Field: brdma_ram_type
    io.field.brdma_ram_type := RegEnable(io.reg.wr_data(5), false.B, nvdla_sdp_rdma_d_brdma_cfg_0_wren)
    // Register: NVDLA_SDP_RDMA_D_BS_BASE_ADDR_HIGH_0    Field: bs_base_addr_high
    io.field.bs_base_addr_high := RegEnable(io.reg.wr_data, "b0".asUInt(32.W), nvdla_sdp_rdma_d_bs_base_addr_high_0_wren)
    // Register: NVDLA_SDP_RDMA_D_BS_BASE_ADDR_LOW_0    Field: bs_base_addr_low
    io.field.bs_base_addr_low := RegEnable(io.reg.wr_data, "b0".asUInt(32.W), nvdla_sdp_rdma_d_bs_base_addr_low_0_wren)
    // Register: NVDLA_SDP_RDMA_D_BS_BATCH_STRIDE_0    Field: bs_batch_stride
    io.field.bs_batch_stride := RegEnable(io.reg.wr_data, "b0".asUInt(32.W), nvdla_sdp_rdma_d_bs_batch_stride_0_wren)
    // Register: NVDLA_SDP_RDMA_D_BS_LINE_STRIDE_0    Field: bs_line_stride
    io.field.bs_line_stride := RegEnable(io.reg.wr_data, "b0".asUInt(32.W), nvdla_sdp_rdma_d_bs_line_stride_0_wren)
    // Register: NVDLA_SDP_RDMA_D_BS_SURFACE_STRIDE_0    Field: bs_surface_stride
    io.field.bs_surface_stride := RegEnable(io.reg.wr_data, "b0".asUInt(32.W), nvdla_sdp_rdma_d_bs_surface_stride_0_wren)
    // Register: NVDLA_SDP_RDMA_D_DATA_CUBE_CHANNEL_0    Field: channel
    io.field.channel := RegEnable(io.reg.wr_data(12, 0), "b0".asUInt(13.W), nvdla_sdp_rdma_d_data_cube_channel_0_wren)
    // Register: NVDLA_SDP_RDMA_D_DATA_CUBE_HEIGHT_0    Field: height
    io.field.height := RegEnable(io.reg.wr_data(12, 0), "b0".asUInt(13.W), nvdla_sdp_rdma_d_data_cube_height_0_wren)
    // Register: NVDLA_SDP_RDMA_D_DATA_CUBE_width_a_0    Field: width_a
    io.field.width_a := RegEnable(io.reg.wr_data(12, 0), "b0".asUInt(13.W), nvdla_sdp_rdma_d_data_cube_width_a_0_wren)
    // Register: NVDLA_SDP_RDMA_D_ERDMA_CFG_0    Field: erdma_data_mode
    io.field.erdma_data_mode := RegEnable(io.reg.wr_data(4), false.B, nvdla_sdp_rdma_d_erdma_cfg_0_wren)
    // Register: NVDLA_SDP_RDMA_D_ERDMA_CFG_0    Field: erdma_data_size
    io.field.erdma_data_size := RegEnable(io.reg.wr_data(3), false.B, nvdla_sdp_rdma_d_erdma_cfg_0_wren)
    // Register: NVDLA_SDP_RDMA_D_ERDMA_CFG_0    Field: erdma_data_use
    io.field.erdma_data_use := RegEnable(io.reg.wr_data(2, 1), "b00".asUInt(2.W), nvdla_sdp_rdma_d_erdma_cfg_0_wren)
    // Register: NVDLA_SDP_RDMA_D_ERDMA_CFG_0    Field: erdma_disable
    io.field.erdma_disable := RegEnable(io.reg.wr_data(0), true.B, nvdla_sdp_rdma_d_erdma_cfg_0_wren)
    // Register: NVDLA_SDP_RDMA_D_ERDMA_CFG_0    Field: erdma_ram_type
    io.field.erdma_ram_type := RegEnable(io.reg.wr_data(5), false.B, nvdla_sdp_rdma_d_erdma_cfg_0_wren)
    // Register: NVDLA_SDP_RDMA_D_EW_BASE_ADDR_HIGH_0    Field: ew_base_addr_high
    io.field.ew_base_addr_high := RegEnable(io.reg.wr_data, "b0".asUInt(32.W), nvdla_sdp_rdma_d_ew_base_addr_high_0_wren)
    // Register: NVDLA_SDP_RDMA_D_EW_BASE_ADDR_LOW_0    Field: ew_base_addr_low
    io.field.ew_base_addr_low := RegEnable(io.reg.wr_data, "b0".asUInt(32.W), nvdla_sdp_rdma_d_ew_base_addr_low_0_wren)
    // Register: NVDLA_SDP_RDMA_D_EW_BATCH_STRIDE_0    Field: ew_batch_stride
    io.field.ew_batch_stride := RegEnable(io.reg.wr_data, "b0".asUInt(32.W), nvdla_sdp_rdma_d_ew_batch_stride_0_wren)
    // Register: NVDLA_SDP_RDMA_D_EW_LINE_STRIDE_0    Field: ew_line_stride
    io.field.ew_line_stride := RegEnable(io.reg.wr_data, "b0".asUInt(32.W), nvdla_sdp_rdma_d_ew_line_stride_0_wren)
    // Register: NVDLA_SDP_RDMA_D_EW_SURFACE_STRIDE_0    Field: ew_surface_stride
    io.field.ew_surface_stride := RegEnable(io.reg.wr_data, "b0".asUInt(32.W), nvdla_sdp_rdma_d_ew_surface_stride_0_wren)
    // Register: NVDLA_SDP_RDMA_D_FEATURE_MODE_CFG_0    Field: batch_number
    io.field.batch_number := RegEnable(io.reg.wr_data(12, 8), "b0".asUInt(32.W), nvdla_sdp_rdma_d_feature_mode_cfg_0_wren)
    // Register: NVDLA_SDP_RDMA_D_FEATURE_MODE_CFG_0    Field: flying_mode
    io.field.flying_mode := RegEnable(io.reg.wr_data(0), false.B, nvdla_sdp_rdma_d_feature_mode_cfg_0_wren)
    // Register: NVDLA_SDP_RDMA_D_FEATURE_MODE_CFG_0    Field: in_precision
    io.field.in_precision := RegEnable(io.reg.wr_data(3, 2), "b01".asUInt(2.W), nvdla_sdp_rdma_d_feature_mode_cfg_0_wren)
    // Register: NVDLA_SDP_RDMA_D_FEATURE_MODE_CFG_0    Field: out_precision
    io.field.out_precision := RegEnable(io.reg.wr_data(7, 6), "b00".asUInt(2.W), nvdla_sdp_rdma_d_feature_mode_cfg_0_wren)
    // Register: NVDLA_SDP_RDMA_D_FEATURE_MODE_CFG_0    Field: proc_precision
    io.field.proc_precision := RegEnable(io.reg.wr_data(5, 4), "b01".asUInt(2.W), nvdla_sdp_rdma_d_feature_mode_cfg_0_wren)
    // Register: NVDLA_SDP_RDMA_D_FEATURE_MODE_CFG_0    Field: winograd
    io.field.winograd := RegEnable(io.reg.wr_data(1), false.B, nvdla_sdp_rdma_d_feature_mode_cfg_0_wren)
    // Register: NVDLA_SDP_RDMA_D_NRDMA_CFG_0    Field: nrdma_data_mode
    io.field.nrdma_data_mode := RegEnable(io.reg.wr_data(4), false.B, nvdla_sdp_rdma_d_nrdma_cfg_0_wren)
    // Register: NVDLA_SDP_RDMA_D_NRDMA_CFG_0    Field: nrdma_data_size
    io.field.nrdma_data_size := RegEnable(io.reg.wr_data(3), false.B, nvdla_sdp_rdma_d_nrdma_cfg_0_wren)
    // Register: NVDLA_SDP_RDMA_D_NRDMA_CFG_0    Field: nrdma_data_use
    io.field.nrdma_data_use := RegEnable(io.reg.wr_data(2, 1), "b00".asUInt(2.W), nvdla_sdp_rdma_d_nrdma_cfg_0_wren)
    // Register: NVDLA_SDP_RDMA_D_NRDMA_CFG_0    Field: nrdma_disable
    io.field.nrdma_disable := RegEnable(io.reg.wr_data(0), true.B, nvdla_sdp_rdma_d_nrdma_cfg_0_wren)
    // Register: NVDLA_SDP_RDMA_D_NRDMA_CFG_0    Field: nrdma_ram_type
    io.field.nrdma_ram_type := RegEnable(io.reg.wr_data(5), false.B, nvdla_sdp_rdma_d_nrdma_cfg_0_wren)
    // Register: NVDLA_SDP_RDMA_D_PERF_ENABLE_0    Field: perf_dma_en
    io.field.perf_dma_en := RegEnable(io.reg.wr_data(0), false.B, nvdla_sdp_rdma_d_perf_enable_0_wren)
    // Register: NVDLA_SDP_RDMA_D_PERF_ENABLE_0    Field: perf_nan_inf_count_en
    io.field.perf_nan_inf_count_en := RegEnable(io.reg.wr_data(1), false.B, nvdla_sdp_rdma_d_perf_enable_0_wren)
    // Register: NVDLA_SDP_RDMA_D_SRC_BASE_ADDR_HIGH_0    Field: src_base_addr_high
    io.field.src_base_addr_high := RegEnable(io.reg.wr_data, "b0".asUInt(32.W), nvdla_sdp_rdma_d_src_base_addr_high_0_wren)
    // Register: NVDLA_SDP_RDMA_D_SRC_BASE_ADDR_LOW_0    Field: src_base_addr_low
    io.field.src_base_addr_low := RegEnable(io.reg.wr_data, "b0".asUInt(32.W), nvdla_sdp_rdma_d_src_base_addr_low_0_wren)
    // Register: NVDLA_SDP_RDMA_D_SRC_DMA_CFG_0    Field: src_ram_type
    io.field.src_ram_type := RegEnable(io.reg.wr_data(0), false.B, nvdla_sdp_rdma_d_src_dma_cfg_0_wren)
    // Register: NVDLA_SDP_RDMA_D_SRC_LINE_STRIDE_0    Field: src_line_stride
    io.field.src_line_stride := RegEnable(io.reg.wr_data, "b0".asUInt(32.W), nvdla_sdp_rdma_d_src_line_stride_0_wren)
    // Register: NVDLA_SDP_RDMA_D_SRC_SURFACE_STRIDE_0    Field: src_surface_stride
    io.field.src_surface_stride := RegEnable(io.reg.wr_data, "b0".asUInt(32.W), nvdla_sdp_rdma_d_src_surface_stride_0_wren)                                                               
