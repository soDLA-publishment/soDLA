...
// class NV_NVDLA_SDP_mrdma(implicit conf: sdpConfiguration) extends Module {
...
//     u_gate.io.rdma_disable := io.mrdma_disable
//     u_gate.io.rdma_slcg_op_en := io.mrdma_slcg_op_en
