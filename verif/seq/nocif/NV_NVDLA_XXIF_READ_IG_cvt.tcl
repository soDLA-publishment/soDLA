...
analyze -format sverilog -library impl {../../small_gate/vmod/nvdla/nocif/NV_NVDLA_MCIF_READ_IG_cvt_wrapper.v 
                                        ../../small_gate/vmod/nvdla/nocif/NV_NVDLA_XXIF_READ_IG_cvt.v}

elaborate_seq -spectop NV_NVDLA_MCIF_READ_IG_cvt -impltop NV_NVDLA_MCIF_READ_IG_cvt_wrapper
