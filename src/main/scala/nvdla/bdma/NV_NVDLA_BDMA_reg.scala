...
class NV_NVDLA_BDMA_reg extends Module{
    ...
    val  nvdla_bdma_cfg_dst_addr_high_0_wren = (io.reg_offset === "h0c".asUInt(32.W)) & reg_wr00000fff)) & io.reg_wr_en ; //spyglass disable UnloadedNet-ML //_en ; //spyglass disable UnloadedNet-ML //(W528)
