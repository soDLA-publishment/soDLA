...
analyze -format sverilog -library impl {../../small_gate/vmod/nvdla/csb_master/NV_NVDLA_csb_master_wrapper.v
                                        ../../small_gate/vmod/nvdla/csb_master/NV_NVDLA_csb_master.v}

elaborate_seq -spectop NV_NVDLA_csb_master_golden_wrapper -impltop NV_NVDLA_csb_master_wrapper
